...
describe("Scenario: Verify project item overview page", () => {
    ...
    it("TC007 - Verify that the page displays the section Avg. Response Time", () => {
        ...
        //Verify new page contains expectedSectionText= Avg. Response Time
        cy.get('div').contains('Avg. Response Time').should('exist').and('be.visible')
