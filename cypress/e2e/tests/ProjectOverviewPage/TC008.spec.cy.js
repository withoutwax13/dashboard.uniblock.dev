...
describe("Scenario: Verify project item overview page", () => {
    ...
    it("TC008 - Verify that the page displays the section Failed Requests", () => {
        ...
        //Verify new page contains expectedSectionText= Failed Requests
        cy.get('div').contains('Failed Requests').should('exist').and('be.visible')
