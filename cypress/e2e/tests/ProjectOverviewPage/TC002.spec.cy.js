...
describe("Scenario: Verify project item overview page", () => {
    ...
    it("TC002 - Verify that the page displays the section View Contracts", () => {
        ...
        cy.get('button').contains('Contracts').should('exist').click()

        //Verify the URL contains expectedURLText	
        cy.url().should('include', 'dashboard/projects/contracts')
    })
})